...
LSTM_MODEL_PATH = os.getenv(
    "LSTM_MODEL_PATH",
    r"C:\kuliah-sementara\SKRIPSI\tuning_results_nthuddd2_percobaan_2"
    r"\SWIN_LSTM_EXP_K\SWIN_LSTM_EXP_K_BEST.pth",
)
...
WARNING_THRESH = 15     # >= 3 drowsy dalam history → WARNING
DANGER_THRESH  = 25    # >= 7 drowsy dalam history → DANGER
...
EYE_CROP_MARGIN = float(os.getenv("EYE_CROP_MARGIN", "0.18"))
