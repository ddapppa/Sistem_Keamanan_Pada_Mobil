...
# ============================================================
st.set_page_config(
    page_title="Drowsy Detection · Thesis 2026",
    page_icon="🛡️",
    layout="wide",
...
class AlarmManager:
    ...
    def _beep_worker(self, level: str, duration: float):
        try:
            ...
            print(f"[ALARM] winsound tidak tersedia: {e}")
...
st.sidebar.markdown(
    ...
    '</div>'
    '</div>'
    '<div class="sb-proj">Thesis Project · 2026</div>'
...
def _page_footer():
    st.markdown(
        ...
        '<div class="pf-r">© 2026 · Thesis Edition</div>'
        '</div>',
        unsafe_allow_html=True,
    )
...
# ============================================================
    ...
    if _HAS_AUTOREFRESH:
        st_autorefresh(interval=500, key="live_panel_refresh")
    else:
        st.warning(
    ...
    st.markdown(
        '<div class="reveal">'
        '<div class="bab-eyebrow">Bab 03 · Demonstrasi</div>'
    ...
    with right_col:
        ...
        st.markdown(
            ...
            f'<div class="al-body">PC Speaker · winsound beep</div>'
            f'</div>'
            f'</div>'
